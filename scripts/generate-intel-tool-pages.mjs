  ...
  return `<article class="tool-card">
    <div class="info">
      ...
      <div class="popover">
        ...
        <p><strong>Operational use:</strong> ${esc(useCaseFor(resource, config))}</p>
    ...
    <p>${esc(resource.notes || useCaseFor(resource, config))}</p>
    <div class="card-meta">
