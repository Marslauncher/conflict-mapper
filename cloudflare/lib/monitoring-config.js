...
export const DEFAULT_TOPICS = [
  ...
  { id: 'geopolitics', name: 'Geopolitics', keywords: ['geopolitics', 'foreign policy', 'diplomacy', 'sanctions', 'treaty', 'summit', 'deterrence', 'coercion', 'gray zone', 'grey zone', 'alliance', 'great power competition'] },
  { id: 'military', name: 'Military', keywords: ['war', 'armed conflict', 'battlefield', 'frontline', 'fighting', 'escalation', 'military', 'missile', 'drone', 'troops', 'marines', 'airstrike', 'warship', 'navy', 'army', 'air force', 'submarine', 'ammunition', 'munitions', 'defense', 'defence', 'hypersonic', 'air defense', 'air defence', 'electronic warfare', 'force posture', 'wargame', 'wargaming'] },
  { id: 'political', name: 'Political', keywords: ['election', 'parliament', 'president', 'minister', 'government', 'coup', 'protest', 'civil unrest', 'emergency powers', 'martial law'] },
  { id: 'economic', name: 'Economic Security', keywords: ['market', 'trade', 'tariff', 'supply chain', 'shipping', 'oil', 'gas', 'energy', 'sanctions', 'export control', 'critical minerals', 'rare earth', 'semiconductor controls'] },
  { id: 'cyber', name: 'Cybersecurity', keywords: ['cyber', 'ransomware', 'malware', 'hack', 'breach', 'espionage', 'zero-day', 'critical vulnerability', 'intrusion', 'disinformation', 'influence operation'] },
  { id: 'infrastructure', name: 'Critical Infrastructure', keywords: ['power grid', 'telecom', 'subsea cable', 'pipeline', 'port', 'rail', 'airport', 'satellite', 'logistics hub', 'data center', 'undersea cable'] },
  { id: 'maritime', name: 'Maritime Security', keywords: ['strait', 'sea lane', 'vessel', 'ship', 'naval', 'port', 'red sea', 'black sea', 'south china sea', 'blockade', 'freedom of navigation', 'exclusive economic zone'] },
  { id: 'energy', name: 'Energy Security', keywords: ['oil', 'gas', 'lng', 'nuclear plant', 'pipeline', 'refinery', 'electricity', 'grid outage', 'uranium supply', 'energy security'] },
...
function hasOperationalSignal(text, category, tags) {
  const value = String(text || '').toLowerCase();
  return /(\bwar\b|\bwars\b|\banti-war\b|\barmed conflict\b|\bfrontline\b|\bbattlefield\b|\bcombat\b|\bfighting\b|\bceasefire\b|\binvasion\b|\bincursion\b|\bescalat|\bblockade\b|\bcoercion\b|\bdeterrence\b|\bgray zone\b|\bgrey zone\b|\bmilitary\b|\bmissiles?\b|\bhypersonic\b|\bair defen[cs]e\b|\belectronic warfare\b|\bforce posture\b|\bwargam(e|ing)\b|\bweapons?\b|\bmunitions?\b|\bairstrike\b|\bstrikes?\b|\bdrone\b|\buav\b|\buas\b|\bunmanned\b|\bwarship\b|\bnaval\b|\bsubmarine\b|\btroops?\b|\bmarine corps\b|\bu\.?s\.?\s+marines?\b|\bmarines?\s+(arrive|deploy|deployed|forces?|troops?)\b|\barmy\b|\bnavy\b|\bair force\b|\bdefen[cs]e minister\b|\bdefen[cs]e ministry\b|\bdefen[cs]e department\b|\bdefen[cs]e procurement\b|\bdefen[cs]e spending\b|\bdefen[cs]e budget\b|\bnato\b|\balliance\b|\bnuclear\b|\buranium\b|\benrichment\b|\biaea\b|\bwarhead\b|\bwmd\b|\bterror\b|\binsurgent\b|\bisis\b|\bal qaeda\b|\bhezbollah\b|\bhouthi\b|\bhamas\b|\bsanctions?\b|\bembargo\b|\bexport controls?\b|\brare earths?\b|\bcritical minerals?\b|\bsemiconductor controls?\b|\bcyberattack\b|\bransomware\b|\bmalware\b|\bespionage\b|\bintelligence\b|\bdisinformation\b|\binfluence operation\b|\bnational security\b|\bsecurity council\b|\bsecurity talks\b|\bcritical infrastructure\b|\bpower grid\b|\bpipeline\b|\bsubsea cable\b|\bundersea cable\b|\blogistics hub\b|\bshipping lane\b|\bsea lane\b|\bshadow fleet\b|\bstrait\b|\bred sea\b|\bblack sea\b|\bsouth china sea\b|\btaiwan strait\b|\bfreedom of navigation\b|\bgaza\b|\bcrimea\b|\btehran\b|\bpyongyang\b|\bindo-pacific\b|\bgeopolitic|\bforeign policy\b|\bdiplomac|\bnegotiations?\b|\bpeace talks\b|\bthink tank\b|\bpolicy brief\b|\bsecurity brief\b|\bresearch report\b|\bweapons? procurement\b|\bindustrial base\b|\bshipbuilding\b|\bammunition\b|\bmunitions\b|\bcoup\b|\bcivil unrest\b|\bemergency powers\b|\bmartial law\b)/.test(value);
}
