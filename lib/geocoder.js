...
const LOCATIONS = {
  ...
  'new york state':       { lat: 42.95, lng: -75.53, country: 'USA',          type: 'region' },
  'new york':             { lat: 40.71, lng: -74.00, country: 'USA',          type: 'city' },
  'new york city':        { lat: 40.71, lng: -74.00, country: 'USA',          type: 'city' },
  'nyc':                  { lat: 40.71, lng: -74.00, country: 'USA',          type: 'city' },
  'california':           { lat: 36.78, lng: -119.42, country: 'USA',         type: 'region' },
  'los angeles':          { lat: 34.05, lng: -118.24, country: 'USA',         type: 'city' },
  'san francisco':        { lat: 37.77, lng: -122.42, country: 'USA',         type: 'city' },
  'san diego':            { lat: 32.72, lng: -117.16, country: 'USA',         type: 'city' },
  'sacramento':           { lat: 38.58, lng: -121.49, country: 'USA',         type: 'city' },
  'texas':                { lat: 31.97, lng: -99.90, country: 'USA',          type: 'region' },
  'houston':              { lat: 29.76, lng: -95.37, country: 'USA',          type: 'city' },
  'dallas':               { lat: 32.78, lng: -96.80, country: 'USA',          type: 'city' },
  'austin':               { lat: 30.27, lng: -97.74, country: 'USA',          type: 'city' },
  'san antonio':          { lat: 29.42, lng: -98.49, country: 'USA',          type: 'city' },
  'florida':              { lat: 27.66, lng: -81.52, country: 'USA',          type: 'region' },
  'miami':                { lat: 25.77, lng: -80.19, country: 'USA',          type: 'city' },
  'tampa':                { lat: 27.95, lng: -82.46, country: 'USA',          type: 'city' },
  'orlando':              { lat: 28.54, lng: -81.38, country: 'USA',          type: 'city' },
  'jacksonville':         { lat: 30.33, lng: -81.66, country: 'USA',          type: 'city' },
  'illinois':             { lat: 40.63, lng: -89.40, country: 'USA',          type: 'region' },
  'chicago':              { lat: 41.88, lng: -87.63, country: 'USA',          type: 'city' },
  'atlanta':              { lat: 33.75, lng: -84.39, country: 'USA',          type: 'city' },
  'georgia state':        { lat: 32.17, lng: -82.90, country: 'USA',          type: 'region' },
  'state of georgia':     { lat: 32.17, lng: -82.90, country: 'USA',          type: 'region' },
  'arizona':              { lat: 34.05, lng: -111.09, country: 'USA',         type: 'region' },
  'phoenix':              { lat: 33.45, lng: -112.07, country: 'USA',         type: 'city' },
  'nevada':               { lat: 38.80, lng: -116.42, country: 'USA',         type: 'region' },
  'las vegas':            { lat: 36.17, lng: -115.14, country: 'USA',         type: 'city' },
  'colorado':             { lat: 39.55, lng: -105.78, country: 'USA',         type: 'region' },
  'denver':               { lat: 39.74, lng: -104.99, country: 'USA',         type: 'city' },
  'washington state':     { lat: 47.75, lng: -120.74, country: 'USA',         type: 'region' },
  'seattle':              { lat: 47.61, lng: -122.33, country: 'USA',         type: 'city' },
  'olympia':              { lat: 47.04, lng: -122.90, country: 'USA',         type: 'city' },
  'oregon':               { lat: 43.80, lng: -120.55, country: 'USA',         type: 'region' },
  'portland':             { lat: 45.52, lng: -122.68, country: 'USA',         type: 'city' },
  'pennsylvania':         { lat: 41.20, lng: -77.19, country: 'USA',          type: 'region' },
  'philadelphia':         { lat: 39.95, lng: -75.17, country: 'USA',          type: 'city' },
  'pittsburgh':           { lat: 40.44, lng: -80.00, country: 'USA',          type: 'city' },
  'ohio':                 { lat: 40.42, lng: -82.91, country: 'USA',          type: 'region' },
  'columbus ohio':        { lat: 39.96, lng: -83.00, country: 'USA',          type: 'city' },
  'cleveland':            { lat: 41.50, lng: -81.69, country: 'USA',          type: 'city' },
  'michigan':             { lat: 44.31, lng: -85.60, country: 'USA',          type: 'region' },
  'detroit':              { lat: 42.33, lng: -83.05, country: 'USA',          type: 'city' },
  'north carolina':       { lat: 35.76, lng: -79.02, country: 'USA',          type: 'region' },
  'charlotte':            { lat: 35.23, lng: -80.84, country: 'USA',          type: 'city' },
  'raleigh':              { lat: 35.78, lng: -78.64, country: 'USA',          type: 'city' },
  'virginia':             { lat: 37.43, lng: -78.66, country: 'USA',          type: 'region' },
  'norfolk':              { lat: 36.85, lng: -76.29, country: 'USA',          type: 'city' },
  'richmond':             { lat: 37.54, lng: -77.44, country: 'USA',          type: 'city' },
  'maryland':             { lat: 39.05, lng: -76.64, country: 'USA',          type: 'region' },
  'baltimore':            { lat: 39.29, lng: -76.61, country: 'USA',          type: 'city' },
  'massachusetts':        { lat: 42.41, lng: -71.38, country: 'USA',          type: 'region' },
  'boston':               { lat: 42.36, lng: -71.06, country: 'USA',          type: 'city' },
  ...
  // ── AUSTRALIA / OCEANIA ─────────────────────────────────────────────────
  'australia':            { lat: -25.27, lng: 133.78, country: 'Australia',   type: 'country' },
  'canberra':             { lat: -35.28, lng: 149.13, country: 'Australia',   type: 'capital' },
  'sydney':               { lat: -33.87, lng: 151.21, country: 'Australia',   type: 'city' },
  'melbourne':            { lat: -37.81, lng: 144.96, country: 'Australia',   type: 'city' },
  'new zealand':          { lat: -40.90, lng: 174.89, country: 'New Zealand', type: 'country' },
  'wellington':           { lat: -41.29, lng: 174.78, country: 'New Zealand', type: 'capital' },
  ...
  'vancouver':            { lat: 49.28, lng: -123.12, country: 'Canada',      type: 'city' },
  'montreal':             { lat: 45.50, lng: -73.57, country: 'Canada',       type: 'city' },
  'alberta':              { lat: 53.93, lng: -116.58, country: 'Canada',      type: 'region' },
  'calgary':              { lat: 51.04, lng: -114.07, country: 'Canada',      type: 'city' },
  'quebec':               { lat: 46.81, lng: -71.21, country: 'Canada',       type: 'region' },
  'british columbia':     { lat: 53.73, lng: -127.65, country: 'Canada',      type: 'region' },
  'mexico':               { lat: 19.43, lng: -99.13, country: 'Mexico',       type: 'country' },
  'mexican':              { lat: 19.43, lng: -99.13, country: 'Mexico',       type: 'country' },
  'mexico city':          { lat: 19.43, lng: -99.13, country: 'Mexico',       type: 'capital' },
  'monterrey':            { lat: 25.69, lng: -100.32, country: 'Mexico',      type: 'city' },
  'guadalajara':          { lat: 20.66, lng: -103.35, country: 'Mexico',      type: 'city' },
  'tijuana':              { lat: 32.51, lng: -117.04, country: 'Mexico',      type: 'city' },
  'ciudad juarez':        { lat: 31.69, lng: -106.42, country: 'Mexico',      type: 'city' },
  'juarez':               { lat: 31.69, lng: -106.42, country: 'Mexico',      type: 'city' },
  'dominican republic':   { lat: 18.49, lng: -69.93, country: 'Dominican Republic', type: 'country' },
  'dominican':            { lat: 18.49, lng: -69.93, country: 'Dominican Republic', type: 'country' },
  'santo domingo':        { lat: 18.49, lng: -69.93, country: 'Dominican Republic', type: 'capital' },
  'haiti':                { lat: 18.59, lng: -72.31, country: 'Haiti',         type: 'country' },
  'port-au-prince':       { lat: 18.59, lng: -72.31, country: 'Haiti',         type: 'capital' },
  'jamaica':              { lat: 18.11, lng: -77.30, country: 'Jamaica',       type: 'country' },
  'kingston':             { lat: 17.97, lng: -76.79, country: 'Jamaica',       type: 'capital' },
  'panama':               { lat:  8.98, lng: -79.52, country: 'Panama',        type: 'country' },
  'panama city':          { lat:  8.98, lng: -79.52, country: 'Panama',        type: 'capital' },
  'guatemala':            { lat: 14.63, lng: -90.51, country: 'Guatemala',     type: 'country' },
  'honduras':             { lat: 14.08, lng: -87.21, country: 'Honduras',      type: 'country' },
  'el salvador':          { lat: 13.69, lng: -89.19, country: 'El Salvador',   type: 'country' },
  'nicaragua':            { lat: 12.11, lng: -86.24, country: 'Nicaragua',     type: 'country' },
  'costa rica':           { lat:  9.93, lng: -84.08, country: 'Costa Rica',    type: 'country' },
  'brazil':               { lat: -15.78, lng: -47.93, country: 'Brazil',      type: 'country' },
  'brasilia':             { lat: -15.78, lng: -47.93, country: 'Brazil',      type: 'capital' },
  'sao paulo':            { lat: -23.55, lng: -46.63, country: 'Brazil',      type: 'city' },
  'rio de janeiro':       { lat: -22.91, lng: -43.17, country: 'Brazil',      type: 'city' },
  ...
  'chile':                { lat: -33.45, lng: -70.67, country: 'Chile',       type: 'country' },
  'santiago':             { lat: -33.45, lng: -70.67, country: 'Chile',       type: 'capital' },
  'peru':                 { lat: -12.05, lng: -77.04, country: 'Peru',        type: 'country' },
  'lima':                 { lat: -12.05, lng: -77.04, country: 'Peru',        type: 'capital' },
  'ecuador':              { lat:  -0.18, lng: -78.47, country: 'Ecuador',     type: 'country' },
  'quito':                { lat:  -0.18, lng: -78.47, country: 'Ecuador',     type: 'capital' },
  'bolivia':              { lat: -16.50, lng: -68.15, country: 'Bolivia',     type: 'country' },
  'paraguay':             { lat: -25.27, lng: -57.58, country: 'Paraguay',    type: 'country' },
  'uruguay':              { lat: -34.90, lng: -56.16, country: 'Uruguay',     type: 'country' },
  'montevideo':           { lat: -34.90, lng: -56.16, country: 'Uruguay',     type: 'capital' },
  ...
  // ── EXPANDED MAP GRANULARITY ────────────────────────────────────────────
  'rostov-on-don':        { lat: 47.2357, lng: 39.7015, country: 'Russia',    type: 'city' },
  'rostov on don':        { lat: 47.2357, lng: 39.7015, country: 'Russia',    type: 'city' },
  'rostov':               { lat: 47.2357, lng: 39.7015, country: 'Russia',    type: 'city' },
  'krasnodar':            { lat: 45.0355, lng: 38.9753, country: 'Russia',    type: 'city' },
  'kazan':                { lat: 55.7961, lng: 49.1064, country: 'Russia',    type: 'city' },
  'tatarstan':            { lat: 55.7961, lng: 49.1064, country: 'Russia',    type: 'region' },
  'yekaterinburg':        { lat: 56.8389, lng: 60.6057, country: 'Russia',    type: 'city' },
  'ekaterinburg':         { lat: 56.8389, lng: 60.6057, country: 'Russia',    type: 'city' },
  'nizhny novgorod':      { lat: 56.2965, lng: 43.9361, country: 'Russia',    type: 'city' },
  'samara':               { lat: 53.1959, lng: 50.1002, country: 'Russia',    type: 'city' },
  'fujian':               { lat: 26.0789, lng: 117.9874, country: 'China',    type: 'region' },
  'xiamen':               { lat: 24.4798, lng: 118.0894, country: 'China',    type: 'city' },
  'fuzhou':               { lat: 26.0745, lng: 119.2965, country: 'China',    type: 'city' },
  'hainan':               { lat: 19.1959, lng: 109.7453, country: 'China',    type: 'region' },
  'dalian':               { lat: 38.9140, lng: 121.6147, country: 'China',    type: 'city' },
  'qingdao':              { lat: 36.0671, lng: 120.3826, country: 'China',    type: 'city' },
  'tianjin':              { lat: 39.3434, lng: 117.3616, country: 'China',    type: 'city' },
  'chongqing':            { lat: 29.5630, lng: 106.5516, country: 'China',    type: 'city' },
  'nanjing':              { lat: 32.0603, lng: 118.7969, country: 'China',    type: 'city' },
  'victoria':             { lat: -36.9848, lng: 143.3906, country: 'Australia', type: 'region' },
  'queensland':           { lat: -20.9176, lng: 142.7028, country: 'Australia', type: 'region' },
  'western australia':    { lat: -25.2303, lng: 121.0187, country: 'Australia', type: 'region' },
  'northern territory':   { lat: -19.4914, lng: 132.5509, country: 'Australia', type: 'region' },
  'brisbane':             { lat: -27.4698, lng: 153.0251, country: 'Australia', type: 'city' },
  'perth':                { lat: -31.9523, lng: 115.8613, country: 'Australia', type: 'city' },
  'adelaide':             { lat: -34.9285, lng: 138.6007, country: 'Australia', type: 'city' },
  'darwin':               { lat: -12.4634, lng: 130.8456, country: 'Australia', type: 'city' },
  'townsville':           { lat: -19.2590, lng: 146.8169, country: 'Australia', type: 'city' },
  'nairobi':              { lat: -1.2921, lng: 36.8219, country: 'Kenya',     type: 'capital' },
  'mombasa':              { lat: -4.0435, lng: 39.6682, country: 'Kenya',     type: 'city' },
  ...
  'darfur':               { lat: 13.6200, lng: 25.3500, country: 'Sudan',     type: 'region' },
  'port sudan':           { lat: 19.6158, lng: 37.2164, country: 'Sudan',     type: 'city' },
  'el fasher':            { lat: 13.6279, lng: 25.3494, country: 'Sudan',     type: 'city' },
  'al fashir':            { lat: 13.6279, lng: 25.3494, country: 'Sudan',     type: 'city' },
  'wad madani':           { lat: 14.4012, lng: 33.5199, country: 'Sudan',     type: 'city' },
  'tigray':               { lat: 14.0323, lng: 38.3166, country: 'Ethiopia',  type: 'region' },
  'oromia':               { lat: 7.5460, lng: 40.6347, country: 'Ethiopia',   type: 'region' },
  'goma':                 { lat: -1.6585, lng: 29.2205, country: 'DRC',       type: 'city' },
  'north kivu':           { lat: -0.7918, lng: 29.0459, country: 'DRC',       type: 'region' },
  'm23':                  { lat: -0.7918, lng: 29.0459, country: 'DRC',       type: 'zone' },
  'bogota':               { lat: 4.7110, lng: -74.0721, country: 'Colombia',  type: 'capital' },
  'bogotá':               { lat: 4.7110, lng: -74.0721, country: 'Colombia',  type: 'capital' },
  'la paz':               { lat: -16.4897, lng: -68.1193, country: 'Bolivia', type: 'capital' },
  'asuncion':             { lat: -25.2637, lng: -57.5759, country: 'Paraguay', type: 'capital' },
  'asunción':             { lat: -25.2637, lng: -57.5759, country: 'Paraguay', type: 'capital' },
  'amazon basin':         { lat: -3.4653, lng: -62.2159, country: 'Regional', type: 'region' },
  'amazon rainforest':    { lat: -3.4653, lng: -62.2159, country: 'Regional', type: 'region' },
  'amazonas':             { lat: -3.4653, lng: -62.2159, country: 'Regional', type: 'region' },
  'guyana':               { lat: 4.8604, lng: -58.9302, country: 'Guyana',    type: 'country' },
  'essequibo':            { lat: 6.8000, lng: -58.8000, country: 'Guyana',    type: 'region' },
};
...
function geocode(text) {
  ...
  for (const [keyword, data] of Object.entries(LOCATIONS)) {
    if (lower.includes(keyword)) {
      const score = keyword.length + locationSpecificityBoost(data.type);
      if (score > bestScore) {
        bestScore = score;
        bestMatch = {
          lat: data.lat,
...
function locationSpecificityBoost(type) {
  return {
    city: 250,
    capital: 240,
    base: 230,
